---
title: "Royco Dawn Vault Products: srRoyUSDC and roywstETH"
...
The curator operates on each vault's multisig with scoped permissions — it can allocate and rebalance within approved parameters, but cannot move funds to unauthorized addresses or alter protocol mechanics. The Royco Foundation retains the ability to revoke curator access at any time.
...
Royco's full audit reports are available in the [Security & Audits](/security/audits) section. The custodians managing vault infrastructure have completed independent audits:

- **Concrete** has been audited by [Cantina](https://docs.concrete.xyz/assets/files/cantinacode-concrete-finance-813b45d86d6450723139b0cc55857c4d.pdf/) and [Halborn](https://docs.concrete.xyz/assets/files/Standard-Implementation-9948d7fcebb518e5c29051bc2326b5ec.pdf/).
- **Makina** has been audited by [ChainSecurity, Enigma Dark, Sigma Prime, Cantina, and Ottersec](https://docs.makina.finance/contracts/security).
